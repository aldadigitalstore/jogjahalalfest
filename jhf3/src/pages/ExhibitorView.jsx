...
export const ExhibitorView = () => {
  const metaTitle = 'Eksibitor | Jogja Halal Fest 2026';
  const metaDescription =
    'Informasi eksibitor Jogja Halal Fest 2026: keuntungan, profil peserta, dan peluang kolaborasi di ekosistem halal global.';
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://jogjahalalfest.com/eksibitor" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Jogja Halal Fest" />
        <meta property="og:title" content={metaTitle} />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:url" content="https://jogjahalalfest.com/eksibitor" />
